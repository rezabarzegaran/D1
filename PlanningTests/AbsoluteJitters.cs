    ...
    public class AbsoluteJitters
    {
        ...
        public void Success_StartTask_Once()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                AbsoluteJitter jitter = new AbsoluteJitter(j);
        ...
        public void Success_IncrementalStartJitter()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                for (int startTimes = 0; startTimes < 50; startTimes += 2)
                {
                    ...
                    Assert.AreEqual(startTimes, jitter.MaxJitter);
                }
            }
        }
        ...
        public void Success_IncrementalEndJitter()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                for (int endTimes = 0; endTimes < 50; endTimes += 2)
                {
                    ...
                    Assert.AreEqual(endTimes, jitter.MaxJitter);
                }
            }
        }
    }
